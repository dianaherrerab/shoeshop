        ...
        <div class="tab-content p-0">
          ...
          <div class="tab-pane fade in show active" id="panel7" role="tabpanel">
            <form method="POST" action="<?php echo URL; ?>/Auth/Register" class="register-form" name="register-form">
              ...
              <div class="modal-body px-5 pt-5 pb-0">
                <input type="hidden" name="role" id="role" class="bordes-input form-control mb-4" value="3">
          ...
          <div class="tab-pane fade" id="panel8" role="tabpanel">
            <form method="POST" action="<?php echo URL; ?>/Auth/Register" class="register-form" name="register-form">
              <div class="errors-register"></div>
              <div class="modal-body px-5 pt-5 pb-0">
                <input type="hidden" name="role" id="role" class="bordes-input form-control mb-4" value="2">
                <input type="text" name="name" id="name" placeholder="Nombre" class="bordes-input form-control mb-4">
                <input type="email" name="username" id="username" placeholder="Correo" class="bordes-input form-control mb-4">
        ...
        <div class="row align-items-center justify-content-center">
          <div class="col-12 order-md-2 col-md-5 text-center">
            <div class="text-md-right my-2">
              <button id="btn-recover" class="btn bg-morado boton-ingresar font-weight-bold mb-4">Enviar</button>
            </div>
          </div>
        </div>
      </form>
